...
import { EscapeMarkdownOptions } from '@discordjs/formatters';
...
export class StringUtils {
    ...
    public static escapeMarkdown(input: string, options?: EscapeMarkdownOptions): string {
        return (
            escapeMarkdown(input, options)
